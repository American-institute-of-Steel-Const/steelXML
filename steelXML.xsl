	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<div class="container">
					<p class=""><xsl:copy-of select="xsd:schema/xsd:annotation/xsd:documentation" /></p>
				<!--
					...
					<xsl:for-each select="xsd:schema/xsd:complexType">
						...
						<td colspan="3">
						<xsl:value-of select="xsd:annotation/xsd:documentation"/></td>
